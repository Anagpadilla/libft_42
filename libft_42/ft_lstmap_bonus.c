 ...
 * application of the function 'f' on each node. 
 * The 'del' function is used to delete the content of a node, if necessary.
 * RETURNS: The new list. NULL if memory allocation fails.
 * */
